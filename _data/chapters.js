module.exports = [{
    ...
    outline: `
      <ol>
        ...
        <li>Previous Works
          <ol>
            <li>Monographs and Dissertations on Roman Religion</li>
            <li>Monographs and Dissertations on Roman Religion and Christianity</li>
            <li>Periodicals and Popular Books</li>
            <li>Summary</li>
          </ol>
        </li>
        <li>Method of Procedure</li>
        <li>Conclusion</li>
      </ol>`,
    introduction: `<p>The edge gained by uncovering the historical background to Scripture cuts two ways. On one hand, historical background adds focus, clarity, and accuracy to the reader’s knowledge of the biblical text. On the other hand, historical research presents a unique challenge to interpretation. Not all background information has equal bearing on exegesis; therefore, the student must discriminate among the data, setting aside what connects tangentially to the text and keeping what directly influences interpretation.</p>
    <p>The dilemma affects a current trend in the interpretation of Paul’s writings: the relationship of his epistles to the imperial cult in first‑century Rome. As more information about early emperor worship comes to light, the allurement to relate Paul’s letters to this fresh data becomes more irresistible. Resisting novelty merely for the sake of tradition or conservatism does not serve the text, the interpreter, or the Church. A cautious evaluation of the evidence, however, will provide two key benefits: it will safeguard against errors that stem from an uncritical use of historical data and it will improve theology with accurately evaluated background information.</p>`,
    conclusion: false
  },
  {
    ...
    outline: `<ol>
      ...
      <li>God – Θεός
        <ol>
          ...
          <li>Similarities and Dissimilarities</li>
        </ol>
      </li>
      <li>Son of God – Υἱὸς θεοῦ
        <ol>
          <li>Imperial Usage</li>
          <li>Pauline Usage
            <ol>
              <li>Occurrences</li>
              <li>Jesus as “Son of God”</li>
              <li>God’s People as “Son(s) of God”</li>
            </ol>
          </li>
          <li>Similarities and Dissimilarities</li>
        </ol>
      ...
      <ol>
        ...
        <li>Lord – Κύριος
          <ol>
            ...
            <li>Occurrences
              <ol>
                <li>“Lord” and Authority</li>
                <li>“Lord” in the Old Testament</li>
                <li>“Lord” and the Apocalypse</li>
                <li>Summary of the Meaning of “Lord”</li>
              </ol>
            </li>
            <li>Similarities and Dissimilarities</li>
          </ol>
        </li>
        <li>Principalities and Powers
          <ol>
            <li>Pauline Usage
              <ol>
                <li>Primary Words</li>
                <li>Related Words</li>
                <li>Theological Emphasis</li>
              </ol>
            </li>
            <li>Similarities and Dissimilarities</li>
          </ol>
  ...
  },
  {
        ...
        <li>Protection: Σωτήρ
          <ol>
            <li>Imperial Usage
              <ol>
                <li>Vocabulary</li>
                <li>Collocate Titles</li>
                <li>Summary</li>
              </ol>
            </li>
            <li>Pauline Usage
              <ol>
                <li>Occurrences of Σωτήρ</li>
                <li>Occurrences of&nbsp;Σωτηρία</li>
                <li>Occurrences of&nbsp;Σῴζω</li>
                <li>Occurrences of&nbsp;Σωτήριος</li>
              </ol>
            </li>
            <li>Similarities and Dissimilarities</li>
          </ol>
        </li>
        <li>Good News: Εὐαγγέλιον
          <ol>
            <li>Imperial Usage</li>
            <li>Pauline Usage
              <ol>
                <li>Occurrences of&nbsp;Εὐαγγέλιον</li>
                <li>Occurrences of&nbsp;Εὐαγγελίζω</li>
              </ol>
            </li>
            <li>Similarities and Dissimilarities</li>
          </ol>
    ...
    introduction: `<p>The Roman imperial cult used divine titles to portray the emperor as a benefactor who cared for and provided for his empire. This use of divine titles can be traced as far back as the Egyptian belief that the Pharoah was responsible to provide protection and prosperity for his nation. Nearly twenty different Greek words ascribe benevolent provision to the emperor. The most prominent titles of benevolence from the imperial cult that also appear regularly in Paul’s epistles are σωτήρ and εὐαγγέλιον. This chapter will examine the use of cognates of both words in both the imperial cult and Paul’s letters, concluding that while the imperial cult provides helpful context for understanding Paul’s letters, the available evidence does not suggest that Paul used these titles in a politically subversive way.</p>`,
    conclusion: `<p>The titles σωτήρ and εὐαγγέλιον, along with their cognates, are shared by Paul’s epistles and the Roman imperial cult. At times, understanding the Roman ideas behind these words helps in the interpretation of Paul’s letters. Cultural background for σωτήρ provides a starting place for understanding Jesus’ work of delivering his people from danger. Understanding the function of the imperial εὐαγγέλιον as an accession announcement sheds light on Paul’s teaching on obedience to the gospel.</p>
    <p>The components of meaning shared by the imperial cult and Paul’s letters do not provide adequate grounds for interpreting Paul’s use of these titles as politically charged propaganda. The eternal salvation that Jesus provides does not conflict with the emperor’s temporal salvation. The good news about Jesus does not present him as a competitor to Caesar’s rule, but as a sacrificial provider of spiritual benefits. Paul’s use of both word groups is clearly in Old Testament prophecies that identify Yahweh as savior and as subject of good news. Thus Paul’s use of the σωτήρ and εὐαγγέλιον word groups serves to identify Jesus with Yahweh, not to position him as a challenger to the emperor.</p>`
  },
  {
        ...
        <li>Introduction
          <ol>
            ...
            <li>Pauline Usage
              <ol>
                <li>Occurrences</li>
                <li>Εἰρήνη in Epistolary Greetings and Benedictions</li>
                <li>Εἰρήνη in Standard Theological Usage</li>
                <li>Summary</li>
              </ol>
            </li>
            <li>Similarities and Dissimilarities</li>
  ...
  },
  {
    ...
    outline: `
      <ol>
        <li>Introduction</li>
        <li>Appearance: Ἐπιφάνεια
          <ol>
            <li>Imperial Usage</li>
            <li>Pauline Usage
              <ol>
                <li>Occurrences</li>
                <li>Ministry Motivation from Jesus’ Ἐπιφάνεια</li>
                <li>Hope for Believer Derived from Jesus’ Ἐπιφάνεια</li>
                <li>Final Victory at Jesus’ Ἐπιφάνεια</li>
                <li>Summary</li>
              </ol>
            </li>
            <li>Similarities and Dissimilarities</li>
        ...
        <li>Arrival: Παρουσία
          <ol>
            ...
            <li>Pauline Usage
              <ol>
                <li>Theological Uses of Παρουσία</li>
                <li>Timing(s) of the Παρουσία</li>
                <li>Summary</li>
              </ol>
            </li>
            <li>Similarities and Dissimilarities</li>
    ...
    introduction: `<p>The presence of the emperor would have brought great honor to a town in the Roman Empire. Citizens treated an imperial visit accordingly and spoke of the emperor’s presence with honorific words. The two most prominent honorific words relating to the presence of the emperor are ἐπιφάνεια and παροuσία. These synonyms emphasize both the splendor of his appearance and occasion of his arrival. Each section of this chapter will begin with an examination of the imperial use of one of these words in first-century Greek literature.</p>
    <p>Paul uses both ἐπιφάνεια and παρουσία with reference to Jesus as well. These words appear most frequently in the Thessalonian letters and pastoral epistles, featuring prominently in eschatological sections of these letters. Comparing Paul’s use of ἐπιφάνεια and παρουσία to the secular first-century use will reveal the degree to which Paul borrowed imperial meaning and show that he did not use these words to subvert the Roman emperor.</p>`,
    conclusion: `<p>The words ἐπιφάνεια (and cognates) and παρουσία both refer to one’s presence, often used of a dignitary or leader. Ἐπιφάνεια emphasizes the appearance of the one present, referring either to the external appearance of the subject or to the act of his appearing. Παρουσία emphasizes the physical presence of its subject, referring either to his state of being present or to his act of arriving. Both these words appear infrequently with imperial referents and both play an important part in Paul’s theology of Jesus’ return.</p>
    <p>Paul’s use of ἐπιφάνεια runs parallel to certain secular uses. As a general or leader making an ἐπιφάνεια often brought deliverance and relief to his subjects, Paul anticipates the ἐπιφάνεια of Jesus as an event at which he brings deliverance and relief to his people (II&nbsp;Tim.&nbsp;4.8; Tit.&nbsp;2.13). He also predicts that Jesus will prevail with military victory at his appearance (II&nbsp;Thess.&nbsp;2.8). Paul is not bound merely to parrot Greco-Roman usage, however. He uses ἐπιφάνεια to communicate the accountability that God’s servants will experience at Jesus’ appearance. This theme is strong in the teachings of Jesus, but does not appear frequently in Greek literature. Paul exalts the Father for his sovereign control over the timing of Jesus’ ἐπιφάνεια. While a Roman official’s appearance may have been governed by his superior, the emperor would not have answered to anyone else.</p>
    <p>Paul’s use of παρουσία likewise bears both similarities to and differences from the Roman usage. Like ἐπιφάνεια, παρουσία appears to take its basic Pauline meaning from the arrivals of dignitaries in the Greek and Roman empires. The eager anticipation that he conveys to his readers reflects the honor of a Roman city visited by the emperor or one of his emissaries. Paul calls his readers to look for Jesus’ παρουσία during difficulties and to live so that he will find them obedient at his arrival. Unlike the normal Roman use, Paul connects the παρουσία of Jesus to the beginning of unfettered enjoyment of resurrection life for his people. The arrival of Jesus also marks the completion of God’s sanctifying work in his people’s lives. Neither of these ideas have any counterpart in secular or imperial cult usage of παρουσία.</p>
    <p>Both ἐπιφάνεια and παρουσία have wide ranges of non-imperial meaning. Even in the sense that most resembles imperial use, each word appears with multiple non-imperial referents in Greek literature. Since these words did not belong exclusively to the imperial cult, Paul’s use of them ought not be construed as subversive or anti-imperial.</p>`
  },
  {
    title: 'Conclusion',
    outline: `
